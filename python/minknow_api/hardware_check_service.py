...
class HardwareCheckService(object):
    def __init__(self, channel: grpc.Channel) -> None:
        ...
        self._full_name = "minknow_api.hardware_check.HardwareCheckService"

    
    def start_hardware_check(self, _message: typing.Optional[typing.Union[StartHardwareCheckRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        """Starts a hardware check against the device and any given positions.This RPC is idempotent. It may change the state of the system, but if the requested
    ...
    def stop_hardware_check(self, _message: typing.Optional[typing.Union[StopHardwareCheckRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        """Stops a hardware check against the device.This RPC is idempotent. It may change the state of the system, but if the requested
        change has already happened, it will not fail because of this, make any additional
        changes or return a different value.
    ...
    def update_hardware_check_results(self, _message: typing.Optional[typing.Union[UpdateHardwareCheckResultsRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        """Sets the latest hardware check result within Core, with the information from the hardware check script.This RPC is idempotent. It may change the state of the system, but if the requested
        change has already happened, it will not fail because of this, make any additional
        changes or return a different value.
    ...
    def stream_hardware_check_results(self, _message: typing.Optional[typing.Union[StreamHardwareCheckResultsRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[StreamHardwareCheckResultsResponse]:
    ...
    def generate_hardware_check_report(self, _message: typing.Optional[typing.Union[GenerateHardwareCheckReportRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[GenerateHardwareCheckReportResponse]:
        """Generate a hardware check result report from a given hardware check ID.This RPC is idempotent. It may change the state of the system, but if the requested
        change has already happened, it will not fail because of this, make any additional
        changes or return a different value.
