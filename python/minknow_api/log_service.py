...
class LogService(object):
    def __init__(self, channel: grpc.Channel) -> None:
        ...
        self._pb = log_pb2
        self._full_name = "minknow_api.log.LogService"

    
    def get_user_messages(self, _message: typing.Optional[typing.Union[GetUserMessagesRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[UserMessage]:
    ...
    def send_user_message(self, _message: typing.Optional[typing.Union[SendUserMessageRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def collect_pings(self, _message: typing.Optional[typing.Union[CollectPingsRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[CollectPingsResponse]:
