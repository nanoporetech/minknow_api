...
class MinionDeviceService(object):
    ...
    def __init__(self, channel: grpc.Channel) -> None:
        ...
        self._full_name = "minknow_api.minion_device.MinionDeviceService"

    
    def change_settings(self, _message: typing.Optional[typing.Union[ChangeSettingsRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        ...
        error).This RPC is idempotent. It may change the state of the system, but if the requested
    ...
    def get_settings(self, _message: typing.Optional[typing.Union[GetSettingsRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def get_fan_speed(self, _message: typing.Optional[typing.Union[GetFanSpeedRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
