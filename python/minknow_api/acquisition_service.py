...
class AcquisitionService(object):
    def __init__(self, channel: grpc.Channel) -> None:
        ...
        self._full_name = "minknow_api.acquisition.AcquisitionService"

    
    def start(self, _message: typing.Optional[typing.Union[StartRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def stop(self, _message: typing.Optional[typing.Union[StopRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def watch_for_status_change(self, iterator: typing.Iterator[WatchForStatusChangeRequest]) -> typing.Iterator[WatchForStatusChangeResponse]:
    ...
    def watch_current_acquisition_run(self, _message: typing.Optional[typing.Union[WatchCurrentAcquisitionRunRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[AcquisitionRunInfo]:
    ...
    def current_status(self, _message: typing.Optional[typing.Union[CurrentStatusRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def get_progress(self, _message: typing.Optional[typing.Union[GetProgressRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def get_acquisition_info(self, _message: typing.Optional[typing.Union[GetAcquisitionRunInfoRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def list_acquisition_runs(self, _message: typing.Optional[typing.Union[ListAcquisitionRunsRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def get_current_acquisition_run(self, _message: typing.Optional[typing.Union[GetCurrentAcquisitionRunRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def set_signal_reader(self, _message: typing.Optional[typing.Union[SetSignalReaderRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def get_signal_reader(self, _message: typing.Optional[typing.Union[GetSignalReaderRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        """Find the signal reader in use. This may have been configured by MinKNOW prior to a protocol being begun.

        Since 6.2This RPC is idempotent. It may change the state of the system, but if the requested
        change has already happened, it will not fail because of this, make any additional
        changes or return a different value.
    ...
    def set_bream_info(self, _message: typing.Optional[typing.Union[SetBreamInfoRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def append_mux_scan_result(self, _message: typing.Optional[typing.Union[MuxScanResult, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
