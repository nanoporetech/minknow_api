...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CHANNELSTATEINFO_STYLE'].fields_by_name['label']._loaded_options = None
  _globals['_CHANNELSTATEINFO_STYLE'].fields_by_name['label']._serialized_options = b'\240\265\030\000'
  _globals['_CHANNELSTATEINFO_STYLE'].fields_by_name['description']._loaded_options = None
  _globals['_CHANNELSTATEINFO_STYLE'].fields_by_name['description']._serialized_options = b'\240\265\030\000'
  _globals['_CHANNELSTATEINFO_STYLE'].fields_by_name['colour']._loaded_options = None
  _globals['_CHANNELSTATEINFO_STYLE'].fields_by_name['colour']._serialized_options = b'\240\265\030\000'
  _globals['_CHANNELSTATEINFO_CHANNELSTATE'].fields_by_name['name']._loaded_options = None
  _globals['_CHANNELSTATEINFO_CHANNELSTATE'].fields_by_name['name']._serialized_options = b'\240\265\030\000'
  _globals['_CHANNELSTATEINFO_GROUP'].fields_by_name['name']._loaded_options = None
  _globals['_CHANNELSTATEINFO_GROUP'].fields_by_name['name']._serialized_options = b'\240\265\030\000'
  _globals['_ACQUISITIONCONFIGSUMMARY'].fields_by_name['basecalling_config_filename']._loaded_options = None
  _globals['_ACQUISITIONCONFIGSUMMARY'].fields_by_name['basecalling_config_filename']._serialized_options = b'\240\265\030\001'
  _globals['_ACQUISITIONCONFIGSUMMARY'].fields_by_name['basecalling_model_version']._loaded_options = None
  _globals['_ACQUISITIONCONFIGSUMMARY'].fields_by_name['basecalling_model_version']._serialized_options = b'\240\265\030\000'
  _globals['_ACQUISITIONCONFIGSUMMARY'].fields_by_name['barcoding_kits']._loaded_options = None
  _globals['_ACQUISITIONCONFIGSUMMARY'].fields_by_name['barcoding_kits']._serialized_options = b'\240\265\030\000'
  _globals['_ACQUISITIONCONFIGSUMMARY'].fields_by_name['alignment_reference_files']._loaded_options = None
  _globals['_ACQUISITIONCONFIGSUMMARY'].fields_by_name['alignment_reference_files']._serialized_options = b'\240\265\030\001'
  _globals['_ACQUISITIONCONFIGSUMMARY'].fields_by_name['alignment_bed_file']._loaded_options = None
  _globals['_ACQUISITIONCONFIGSUMMARY'].fields_by_name['alignment_bed_file']._serialized_options = b'\240\265\030\001'
  _globals['_ACQUISITIONCONFIGSUMMARY'].fields_by_name['lamp_kit']._loaded_options = None
  _globals['_ACQUISITIONCONFIGSUMMARY'].fields_by_name['lamp_kit']._serialized_options = b'\240\265\030\000'
  _globals['_ACQUISITIONCONFIGSUMMARY'].fields_by_name['reads_directory']._loaded_options = None
  ...
  _globals['_MUXSCANMETADATA_STYLE'].fields_by_name['label']._serialized_options = b'\240\265\030\000'
  _globals['_MUXSCANMETADATA_STYLE'].fields_by_name['description']._loaded_options = None
  _globals['_MUXSCANMETADATA_STYLE'].fields_by_name['description']._serialized_options = b'\240\265\030\000'
  _globals['_MUXSCANMETADATA_STYLE'].fields_by_name['colour']._loaded_options = None
  _globals['_MUXSCANMETADATA_STYLE'].fields_by_name['colour']._serialized_options = b'\240\265\030\000'
  _globals['_MUXSCANMETADATA_CATEGORY'].fields_by_name['name']._loaded_options = None
  ...
  _globals['_MUXSCANRESULT'].fields_by_name['counts']._serialized_options = b'\240\265\030\000'
  _globals['_ACQUISITIONRUNINFO'].fields_by_name['run_id']._loaded_options = None
  _globals['_ACQUISITIONRUNINFO'].fields_by_name['run_id']._serialized_options = b'\240\265\030\000'
  _globals['_SETSIGNALREADERREQUEST_SIGNALREADERTYPE']._loaded_options = None
  _globals['_SETSIGNALREADERREQUEST_SIGNALREADERTYPE']._serialized_options = b'\020\001'
  _globals['_SETSIGNALREADERREQUEST'].fields_by_name['reader']._loaded_options = None
  ...
  _globals['_ACQUISITIONYIELDSUMMARY']._serialized_end=2557
  _globals['_ACQUISITIONYIELDSUMMARY_TOTALSPERDUPLEXCATEGORY']._serialized_start=2438
  _globals['_ACQUISITIONYIELDSUMMARY_TOTALSPERDUPLEXCATEGORY']._serialized_end=2557
  _globals['_ACQUISITIONWRITERSUMMARY']._serialized_start=2560
  _globals['_ACQUISITIONWRITERSUMMARY']._serialized_end=2710
  _globals['_CHANNELSTATEINFO']._serialized_start=2713
  _globals['_CHANNELSTATEINFO']._serialized_end=3176
  _globals['_CHANNELSTATEINFO_STYLE']._serialized_start=2798
  _globals['_CHANNELSTATEINFO_STYLE']._serialized_end=2875
  _globals['_CHANNELSTATEINFO_CHANNELSTATE']._serialized_start=2878
  _globals['_CHANNELSTATEINFO_CHANNELSTATE']._serialized_end=3010
