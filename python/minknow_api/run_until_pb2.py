...
EstimatedTimeRemainingUpdate = _reflection.GeneratedProtocolMessageType('EstimatedTimeRemainingUpdate', (_message.Message,), {
  ...
  'Estimated' : _reflection.GeneratedProtocolMessageType('Estimated', (_message.Message,), {
    ...
    '__module__' : 'minknow_api.run_until_pb2'
    ,
    '__doc__': """ These runtimes are estimates of the runtime at which the condition
    will be fulfilled, measured in seconds since the start of the
    acquisition.  Some idea of the expected accuracy of this estimate can
    be obtained by comparing `min_time` with `max_time`.  If the estimated
    time is believed to be accurate (e.g. for a "runtime" criterion), then
    `min_time` may be equal to `max_time`.  Otherwise, if the estimate is
    believed to be inaccurate (e.g. for a "pore_scan" criterion which is
    not close to being fulfilled), then `min_time` and `max_time` may
...
Update = _reflection.GeneratedProtocolMessageType('Update', (_message.Message,), {
  ...
  '__doc__': """Attributes:
      runtime:
          The timestamp of this update Measured in seconds after the
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CRITERIAVALUES._serialized_start=113
  _CRITERIAVALUES._serialized_end=271
  _CRITERIAVALUES_CRITERIAENTRY._serialized_start=202
  _CRITERIAVALUES_CRITERIAENTRY._serialized_end=271
  _GETSTANDARDCRITERIAREQUEST._serialized_start=273
  _GETSTANDARDCRITERIAREQUEST._serialized_end=301
  _GETSTANDARDCRITERIARESPONSE._serialized_start=303
  _GETSTANDARDCRITERIARESPONSE._serialized_end=389
  _WRITETARGETCRITERIAREQUEST._serialized_start=392
  _WRITETARGETCRITERIAREQUEST._serialized_end=579
  _WRITETARGETCRITERIARESPONSE._serialized_start=581
  _WRITETARGETCRITERIARESPONSE._serialized_end=610
  _STREAMTARGETCRITERIAREQUEST._serialized_start=612
  _STREAMTARGETCRITERIAREQUEST._serialized_end=675
  _STREAMTARGETCRITERIARESPONSE._serialized_start=678
  _STREAMTARGETCRITERIARESPONSE._serialized_end=833
  _WRITECUSTOMPROGRESSREQUEST._serialized_start=835
  _WRITECUSTOMPROGRESSREQUEST._serialized_end=961
  _WRITECUSTOMPROGRESSRESPONSE._serialized_start=963
  _WRITECUSTOMPROGRESSRESPONSE._serialized_end=992
  _STREAMPROGRESSREQUEST._serialized_start=994
  _STREAMPROGRESSREQUEST._serialized_end=1051
  _STREAMPROGRESSRESPONSE._serialized_start=1053
  _STREAMPROGRESSRESPONSE._serialized_end=1141
  _ESTIMATEDTIMEREMAININGUPDATE._serialized_start=1144
  _ESTIMATEDTIMEREMAININGUPDATE._serialized_end=1886
  _ESTIMATEDTIMEREMAININGUPDATE_NOTESTIMATED._serialized_start=1361
  _ESTIMATEDTIMEREMAININGUPDATE_NOTESTIMATED._serialized_end=1375
  _ESTIMATEDTIMEREMAININGUPDATE_ESTIMATED._serialized_start=1377
  _ESTIMATEDTIMEREMAININGUPDATE_ESTIMATED._serialized_end=1430
  _ESTIMATEDTIMEREMAININGUPDATE_ESTIMATEDTIME._serialized_start=1433
  _ESTIMATEDTIMEREMAININGUPDATE_ESTIMATEDTIME._serialized_end=1632
  _ESTIMATEDTIMEREMAININGUPDATE_ESTIMATEDTIMES._serialized_start=1635
  _ESTIMATEDTIMEREMAININGUPDATE_ESTIMATEDTIMES._serialized_end=1886
  _ESTIMATEDTIMEREMAININGUPDATE_ESTIMATEDTIMES_ESTIMATEDTIMESENTRY._serialized_start=1766
  _ESTIMATEDTIMEREMAININGUPDATE_ESTIMATEDTIMES_ESTIMATEDTIMESENTRY._serialized_end=1886
  _ACTIONUPDATE._serialized_start=1888
  _ACTIONUPDATE._serialized_end=2010
  _ACTIONUPDATE_ACTION._serialized_start=1964
  _ACTIONUPDATE_ACTION._serialized_end=2010
  _SCRIPTUPDATE._serialized_start=2013
  _SCRIPTUPDATE._serialized_end=2198
  _SCRIPTUPDATE_STARTED._serialized_start=2170
  _SCRIPTUPDATE_STARTED._serialized_end=2179
  _SCRIPTUPDATE_CRITERIAUPDATED._serialized_start=2181
  _SCRIPTUPDATE_CRITERIAUPDATED._serialized_end=2198
  _ERRORUPDATE._serialized_start=2201
  _ERRORUPDATE._serialized_end=2437
  _ERRORUPDATE_INVALIDCRITERIA._serialized_start=2366
  _ERRORUPDATE_INVALIDCRITERIA._serialized_end=2397
  _ERRORUPDATE_OTHERERROR._serialized_start=2399
  _ERRORUPDATE_OTHERERROR._serialized_end=2428
  _UPDATE._serialized_start=2440
  _UPDATE._serialized_end=2774
  _WRITEUPDATESREQUEST._serialized_start=2776
  _WRITEUPDATESREQUEST._serialized_end=2878
  _WRITEUPDATESRESPONSE._serialized_start=2880
  _WRITEUPDATESRESPONSE._serialized_end=2902
  _STREAMUPDATESREQUEST._serialized_start=2904
  _STREAMUPDATESREQUEST._serialized_end=2960
  _STREAMUPDATESRESPONSE._serialized_start=2962
  _STREAMUPDATESRESPONSE._serialized_end=3032
  _RUNUNTILSERVICE._serialized_start=3035
  _RUNUNTILSERVICE._serialized_end=3926
