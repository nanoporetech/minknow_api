...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in minknow_api/protocol_pb2_grpc.py depends on'
...
class ProtocolServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.generate_run_report = channel.unary_stream(
                ...
                _registered_method=True)
        self.watch_clearing_historic_data = channel.unary_stream(
                '/minknow_api.protocol.ProtocolService/watch_clearing_historic_data',
                request_serializer=minknow__api_dot_protocol__pb2.WatchClearingHistoricDataRequest.SerializeToString,
                response_deserializer=minknow__api_dot_protocol__pb2.ClearedHistoricData.FromString,
                _registered_method=True)
        self.set_protocol_script_restartable = channel.unary_unary(
                '/minknow_api.protocol.ProtocolService/set_protocol_script_restartable',
                request_serializer=minknow__api_dot_protocol__pb2.SetProtocolRestartableRequest.SerializeToString,
                response_deserializer=minknow__api_dot_protocol__pb2.SetProtocolRestartableResponse.FromString,
                _registered_method=True)
...
class ProtocolServiceServicer(object):
    ...
    def watch_clearing_historic_data(self, request, context):
    ...
    def set_protocol_script_restartable(self, request, context):
...
def add_ProtocolServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'watch_clearing_historic_data': grpc.unary_stream_rpc_method_handler(
                    servicer.watch_clearing_historic_data,
                    request_deserializer=minknow__api_dot_protocol__pb2.WatchClearingHistoricDataRequest.FromString,
                    response_serializer=minknow__api_dot_protocol__pb2.ClearedHistoricData.SerializeToString,
            ),
            'set_protocol_script_restartable': grpc.unary_unary_rpc_method_handler(
                    servicer.set_protocol_script_restartable,
                    request_deserializer=minknow__api_dot_protocol__pb2.SetProtocolRestartableRequest.FromString,
                    response_serializer=minknow__api_dot_protocol__pb2.SetProtocolRestartableResponse.SerializeToString,
            ),
    }
...
class ProtocolService(object):
    ...
    @staticmethod
    def watch_clearing_historic_data(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/minknow_api.protocol.ProtocolService/watch_clearing_historic_data',
            minknow__api_dot_protocol__pb2.WatchClearingHistoricDataRequest.SerializeToString,
            minknow__api_dot_protocol__pb2.ClearedHistoricData.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    @staticmethod
    def set_protocol_script_restartable(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/minknow_api.protocol.ProtocolService/set_protocol_script_restartable',
            minknow__api_dot_protocol__pb2.SetProtocolRestartableRequest.SerializeToString,
            minknow__api_dot_protocol__pb2.SetProtocolRestartableResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
