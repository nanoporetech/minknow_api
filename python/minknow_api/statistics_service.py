...
class StatisticsService(object):
    def __init__(self, channel: grpc.Channel) -> None:
        ...
        self._full_name = "minknow_api.statistics.StatisticsService"

    
    def stream_duty_time(self, _message: typing.Optional[typing.Union[StreamDutyTimeRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[StreamDutyTimeResponse]:
    ...
    def stream_acquisition_output(self, _message: typing.Optional[typing.Union[StreamAcquisitionOutputRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[StreamAcquisitionOutputResponse]:
    ...
    def stream_writer_output(self, _message: typing.Optional[typing.Union[StreamWriterOutputRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[StreamWriterOutputResponse]:
    ...
    def stream_encountered_acquisition_output_keys(self, _message: typing.Optional[typing.Union[StreamEncounteredAcquisitionOutputKeysRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[StreamEncounteredAcquisitionOutputKeysResponse]:
    ...
    def stream_temperature(self, _message: typing.Optional[typing.Union[StreamTemperatureRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[StreamTemperatureResponse]:
    ...
    def stream_bias_voltages(self, _message: typing.Optional[typing.Union[StreamBiasVoltagesRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[StreamBiasVoltagesResponse]:
    ...
    def stream_read_length_histogram(self, _message: typing.Optional[typing.Union[StreamReadLengthHistogramRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[StreamReadLengthHistogramResponse]:
    ...
    def read_length_n50(self, _message: typing.Optional[typing.Union[ReadLengthN50Request, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def get_read_length_types(self, _message: typing.Optional[typing.Union[GetReadLengthTypesRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def stream_q_score_histogram(self, _message: typing.Optional[typing.Union[StreamQScoreHistogramRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[StreamQScoreHistogramResponse]:
    ...
    def stream_q_accuracy_histogram(self, _message: typing.Optional[typing.Union[StreamQAccuracyHistogramRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[StreamQAccuracyHistogramResponse]:
    ...
    def stream_basecall_boxplots(self, _message: typing.Optional[typing.Union[StreamBoxplotRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[BoxplotResponse]:
