...
class AnalysisConfigurationService(object):
    def __init__(self, channel: grpc.Channel) -> None:
        ...
        self._full_name = "minknow_api.analysis_configuration.AnalysisConfigurationService"

    
    def get_analysis_configuration(self, _message: typing.Optional[typing.Union[GetAnalysisConfigurationRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def set_analysis_configuration(self, _message: typing.Optional[typing.Union[AnalysisConfiguration, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        ...
        or with the new one, but it cannot be used interleaved!This RPC is idempotent. It may change the state of the system, but if the requested
    ...
    def reset_analysis_configuration(self, _message: typing.Optional[typing.Union[ResetAnalysisConfigurationRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        """Reset the analysis configuration

        The configuration will be set to the initial default configuration that was set on boot

        Since 3.0This RPC is idempotent. It may change the state of the system, but if the requested
        change has already happened, it will not fail because of this, make any additional
        changes or return a different value.
    ...
    def set_analysis_enabled_state(self, _message: typing.Optional[typing.Union[SetAnalysisEnabledStateRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        """Enable or disable analysis entirely.This RPC is idempotent. It may change the state of the system, but if the requested
        change has already happened, it will not fail because of this, make any additional
        changes or return a different value.
    ...
    def get_channel_states_desc(self, _message: typing.Optional[typing.Union[GetChannelStatesDescRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def get_summary(self, _message: typing.Optional[typing.Union[GetSummaryRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def set_basecaller_configuration(self, _message: typing.Optional[typing.Union[SetBasecallerConfigurationRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def preload_basecaller_configuration(self, _message: typing.Optional[typing.Union[SetBasecallerConfigurationRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        ...
        Since 4.1This RPC is idempotent. It may change the state of the system, but if the requested
        change has already happened, it will not fail because of this, make any additional
        changes or return a different value.
    ...
    def get_basecaller_configuration(self, _message: typing.Optional[typing.Union[GetBasecallerConfigurationRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def get_pore_type_configuration(self, _message: typing.Optional[typing.Union[GetPoreTypeConfigurationRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def set_pore_type_configuration(self, _message: typing.Optional[typing.Union[PoreTypeConfiguration, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        ...
        Since 3.2This RPC is idempotent. It may change the state of the system, but if the requested
        change has already happened, it will not fail because of this, make any additional
        changes or return a different value.
    ...
    def set_writer_configuration(self, _message: typing.Optional[typing.Union[WriterConfiguration, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        ...
        Since 3.3This RPC is idempotent. It may change the state of the system, but if the requested
        change has already happened, it will not fail because of this, make any additional
        changes or return a different value.
        ...
        Args:
            ...
            read_fast5 (minknow_api.analysis_configuration_pb2.WriterConfiguration.ReadFast5Configuration, optional): Configuration for the fast5 writer.
                ...
                DEPRECATED since 6.10: read fast5 support will be removed in a future release.
    ...
    def get_writer_configuration(self, _message: typing.Optional[typing.Union[GetWriterConfigurationRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def get_read_classifications(self, _message: typing.Optional[typing.Union[GetReadClassificationsRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def get_dynamic_analysis_configuration(self, _message: typing.Optional[typing.Union[GetDynamicAnalysisConfigurationRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def set_dynamic_analysis_configuration(self, _message: typing.Optional[typing.Union[DynamicAnalysisConfiguration, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        ...
        Args:
            ...
            signal_fixing_params (minknow_api.analysis_configuration_pb2.SignalFixingParams, optional): Configure signal fixing.

                Signal fixing compensates for current spikes across the flow cell (as can happen
                when unblocking, for example) by using membrane-only channels as a reference.

                This is normally called by the protocol while acquisition is running. The protocol
                is expected to use data from the acquisition to determine which channels to use
                for signal fixing.
        ...
        if "signal_fixing_params" in kwargs:
            unused_args.remove("signal_fixing_params")
            _message.signal_fixing_params.CopyFrom(kwargs['signal_fixing_params'])
    ...
    def find_basecall_configuration_defaults(self, _message: typing.Optional[typing.Union[FindBasecallConfigurationDefaultsRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
