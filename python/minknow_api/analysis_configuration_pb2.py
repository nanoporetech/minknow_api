...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ANALYSISCONFIGURATION_CHANNELSTATESENTRY']._loaded_options = None
  _globals['_ANALYSISCONFIGURATION_CHANNELSTATESENTRY']._serialized_options = b'8\001'
  _globals['_SETANALYSISENABLEDSTATEREQUEST'].fields_by_name['enable']._loaded_options = None
  _globals['_SETANALYSISENABLEDSTATEREQUEST'].fields_by_name['enable']._serialized_options = b'\210\265\030\001'
  _globals['_BARCODINGCONFIGURATION'].fields_by_name['barcoding_kits']._loaded_options = None
  _globals['_BARCODINGCONFIGURATION'].fields_by_name['barcoding_kits']._serialized_options = b'\240\265\030\000'
  _globals['_ALIGNMENTCONFIGURATION'].fields_by_name['reference_files']._loaded_options = None
  _globals['_ALIGNMENTCONFIGURATION'].fields_by_name['reference_files']._serialized_options = b'\240\265\030\001'
  _globals['_ALIGNMENTCONFIGURATION'].fields_by_name['bed_file']._loaded_options = None
  _globals['_ALIGNMENTCONFIGURATION'].fields_by_name['bed_file']._serialized_options = b'\240\265\030\001'
  _globals['_LAMPCONFIGURATION'].fields_by_name['lamp_kit']._loaded_options = None
  _globals['_LAMPCONFIGURATION'].fields_by_name['lamp_kit']._serialized_options = b'\240\265\030\000'
  _globals['_BASECALLERCONFIGURATION_MODELNAMES'].fields_by_name['simplex_model']._loaded_options = None
  _globals['_BASECALLERCONFIGURATION_MODELNAMES'].fields_by_name['simplex_model']._serialized_options = b'\240\265\030\000'
  _globals['_BASECALLERCONFIGURATION_MODELNAMES'].fields_by_name['modified_models']._loaded_options = None
  _globals['_BASECALLERCONFIGURATION_MODELNAMES'].fields_by_name['modified_models']._serialized_options = b'\240\265\030\000'
  _globals['_BASECALLERCONFIGURATION_MODELNAMES'].fields_by_name['stereo_model']._loaded_options = None
  _globals['_BASECALLERCONFIGURATION_MODELNAMES'].fields_by_name['stereo_model']._serialized_options = b'\240\265\030\000'
  _globals['_BASECALLERCONFIGURATION'].fields_by_name['config_filename']._loaded_options = None
  _globals['_BASECALLERCONFIGURATION'].fields_by_name['config_filename']._serialized_options = b'\240\265\030\001'
  _globals['_BASECALLERCONFIGURATION'].fields_by_name['poly_a_config_path']._loaded_options = None
  _globals['_BASECALLERCONFIGURATION'].fields_by_name['poly_a_config_path']._serialized_options = b'\240\265\030\001'
  _globals['_SETBASECALLERCONFIGURATIONREQUEST'].fields_by_name['configs']._loaded_options = None
  _globals['_SETBASECALLERCONFIGURATIONREQUEST'].fields_by_name['configs']._serialized_options = b'\220\265\030\001'
  _globals['_PORETYPECONFIGURATION_CHANNELWELLPORETYPECONFIGURATIONS_PORETYPESENTRY']._loaded_options = None
  _globals['_PORETYPECONFIGURATION_CHANNELWELLPORETYPECONFIGURATIONS_PORETYPESENTRY']._serialized_options = b'8\001'
  _globals['_WRITERCONFIGURATION_READFAST5CONFIGURATION'].fields_by_name['file_pattern']._loaded_options = None
  _globals['_WRITERCONFIGURATION_READFAST5CONFIGURATION'].fields_by_name['file_pattern']._serialized_options = b'\240\265\030\000'
  _globals['_WRITERCONFIGURATION_READFAST5CONFIGURATION'].fields_by_name['fastq_header_pattern']._loaded_options = None
  _globals['_WRITERCONFIGURATION_READFAST5CONFIGURATION'].fields_by_name['fastq_header_pattern']._serialized_options = b'\240\265\030\000'
  _globals['_WRITERCONFIGURATION_READFASTQCONFIGURATION'].fields_by_name['file_pattern']._loaded_options = None
  _globals['_WRITERCONFIGURATION_READFASTQCONFIGURATION'].fields_by_name['file_pattern']._serialized_options = b'\240\265\030\000'
  _globals['_WRITERCONFIGURATION_READFASTQCONFIGURATION'].fields_by_name['header_pattern']._loaded_options = None
  _globals['_WRITERCONFIGURATION_READFASTQCONFIGURATION'].fields_by_name['header_pattern']._serialized_options = b'\240\265\030\000'
  _globals['_WRITERCONFIGURATION_READBAMCONFIGURATION'].fields_by_name['file_pattern']._loaded_options = None
  _globals['_WRITERCONFIGURATION_READBAMCONFIGURATION'].fields_by_name['file_pattern']._serialized_options = b'\240\265\030\000'
  _globals['_WRITERCONFIGURATION_READPOD5CONFIGURATION'].fields_by_name['file_pattern']._loaded_options = None
  _globals['_WRITERCONFIGURATION_READPOD5CONFIGURATION'].fields_by_name['file_pattern']._serialized_options = b'\240\265\030\000'
  _globals['_WRITERCONFIGURATION_SEQUENCINGSUMMARYCONFIGURATION'].fields_by_name['file_pattern']._loaded_options = None
  _globals['_WRITERCONFIGURATION_SEQUENCINGSUMMARYCONFIGURATION'].fields_by_name['file_pattern']._serialized_options = b'\240\265\030\000'
  _globals['_WRITERCONFIGURATION_BULKCONFIGURATION'].fields_by_name['file_pattern']._loaded_options = None
  _globals['_WRITERCONFIGURATION_BULKCONFIGURATION'].fields_by_name['file_pattern']._serialized_options = b'\240\265\030\000'
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['pdf_report_file_pattern']._loaded_options = None
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['pdf_report_file_pattern']._serialized_options = b'\240\265\030\000'
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['json_report_file_pattern']._loaded_options = None
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['json_report_file_pattern']._serialized_options = b'\240\265\030\000'
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['html_report_file_pattern']._loaded_options = None
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['html_report_file_pattern']._serialized_options = b'\240\265\030\000'
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['markdown_report_file_pattern']._loaded_options = None
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['markdown_report_file_pattern']._serialized_options = b'\240\265\030\000'
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['duty_time_report_file_pattern']._loaded_options = None
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['duty_time_report_file_pattern']._serialized_options = b'\240\265\030\000'
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['throughput_report_file_pattern']._loaded_options = None
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['throughput_report_file_pattern']._serialized_options = b'\240\265\030\000'
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['final_summary_report_file_pattern']._loaded_options = None
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['final_summary_report_file_pattern']._serialized_options = b'\240\265\030\000'
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['barcode_alignment_report_file_pattern']._loaded_options = None
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['barcode_alignment_report_file_pattern']._serialized_options = b'\240\265\030\000'
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['sample_sheet_report_file_pattern']._loaded_options = None
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['sample_sheet_report_file_pattern']._serialized_options = b'\240\265\030\000'
  _globals['_WRITERCONFIGURATION_REPORTCONFIGURATION'].fields_by_name['custom_report_suffix_pattern']._loaded_options = None
  ...
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['set_analysis_configuration']._loaded_options = None
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['set_analysis_configuration']._serialized_options = b'\220\002\002'
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['reset_analysis_configuration']._loaded_options = None
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['reset_analysis_configuration']._serialized_options = b'\220\002\002'
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['set_analysis_enabled_state']._loaded_options = None
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['set_analysis_enabled_state']._serialized_options = b'\220\002\002'
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['get_channel_states_desc']._loaded_options = None
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['get_channel_states_desc']._serialized_options = b'\220\002\001'
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['get_summary']._loaded_options = None
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['get_summary']._serialized_options = b'\220\002\001'
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['set_basecaller_configuration']._loaded_options = None
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['set_basecaller_configuration']._serialized_options = b'\220\002\002'
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['preload_basecaller_configuration']._loaded_options = None
  ...
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['get_basecaller_configuration']._loaded_options = None
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['get_basecaller_configuration']._serialized_options = b'\220\002\001'
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['get_pore_type_configuration']._loaded_options = None
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['get_pore_type_configuration']._serialized_options = b'\220\002\001'
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['set_pore_type_configuration']._loaded_options = None
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['set_pore_type_configuration']._serialized_options = b'\220\002\002'
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['set_writer_configuration']._loaded_options = None
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['set_writer_configuration']._serialized_options = b'\220\002\002'
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['get_writer_configuration']._loaded_options = None
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['get_writer_configuration']._serialized_options = b'\220\002\001'
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['get_read_classifications']._loaded_options = None
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['get_read_classifications']._serialized_options = b'\220\002\001'
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['get_dynamic_analysis_configuration']._loaded_options = None
  ...
  _globals['_ANALYSISCONFIGURATIONSERVICE'].methods_by_name['find_basecall_configuration_defaults']._loaded_options = None
  ...
  _globals['_READDETECTIONPARAMS']._serialized_end=1465
  _globals['_READDETECTIONPARAMS_READDETECTIONMODE']._serialized_start=1394
  _globals['_READDETECTIONPARAMS_READDETECTIONMODE']._serialized_end=1465
...
ReadClassificationParams.__doc__ = """Attributes:
    ...
    selected_ewma_weight:
        A weighting figure for the exponentially weighted moving
        average given to the newest data when tracking selected
        chunks. eg. 0.7 would weight new data with 0.3 and all
        previous data with 0.7.  By default 0.5 is used.
    selected_ignore_after_reset_seconds:
        A number of seconds to ignore new chunks for after a reset
        occurs on a channel when tracking selected chunks this allows
        analysis to ignore spikes or bad data on the channel for a
        small section of time.  By default 0.0 is used - and chunks
