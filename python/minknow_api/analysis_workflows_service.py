...
class AnalysisWorkflowsService(object):
    def __init__(self, channel: grpc.Channel) -> None:
        ...
        self._full_name = "minknow_api.analysis_workflows.AnalysisWorkflowsService"

    
    def proxy(self, _message: typing.Optional[typing.Union[ProxyRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[ProxyResponse]:
        """
