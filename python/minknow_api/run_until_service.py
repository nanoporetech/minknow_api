...
class RunUntilService(object):
    ...
    def __init__(self, channel: grpc.Channel) -> None:
        ...
        self._full_name = "minknow_api.run_until.RunUntilService"

    
    def write_target_criteria(self, _message: typing.Optional[typing.Union[WriteTargetCriteriaRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def stream_target_criteria(self, _message: typing.Optional[typing.Union[StreamTargetCriteriaRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[StreamTargetCriteriaResponse]:
    ...
    def write_updates(self, _message: typing.Optional[typing.Union[WriteUpdatesRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def stream_updates(self, _message: typing.Optional[typing.Union[StreamUpdatesRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[StreamUpdatesResponse]:
