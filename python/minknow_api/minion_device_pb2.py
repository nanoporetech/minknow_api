...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_MINIONDEVICESETTINGS_CHANNELCONFIGENTRY']._loaded_options = None
  _globals['_MINIONDEVICESETTINGS_CHANNELCONFIGENTRY']._serialized_options = b'8\001'
  _globals['_CHANGESETTINGSREQUEST'].fields_by_name['settings']._loaded_options = None
  _globals['_CHANGESETTINGSREQUEST'].fields_by_name['settings']._serialized_options = b'\220\265\030\001'
  _globals['_GETSETTINGSRESPONSE'].fields_by_name['settings']._loaded_options = None
  _globals['_GETSETTINGSRESPONSE'].fields_by_name['settings']._serialized_options = b'\220\265\030\001'
  _globals['_MINIONDEVICESERVICE'].methods_by_name['change_settings']._loaded_options = None
  _globals['_MINIONDEVICESERVICE'].methods_by_name['change_settings']._serialized_options = b'\220\002\002'
  _globals['_MINIONDEVICESERVICE'].methods_by_name['get_settings']._loaded_options = None
  _globals['_MINIONDEVICESERVICE'].methods_by_name['get_settings']._serialized_options = b'\220\002\001'
  _globals['_MINIONDEVICESERVICE'].methods_by_name['get_fan_speed']._loaded_options = None
  ...
  _globals['_MINIONDEVICESETTINGS']._serialized_end=3319
  _globals['_MINIONDEVICESETTINGS_CHANNELCONFIGENTRY']._serialized_start=2221
  _globals['_MINIONDEVICESETTINGS_CHANNELCONFIGENTRY']._serialized_end=2336
  _globals['_MINIONDEVICESETTINGS_GAIN']._serialized_start=2338
  _globals['_MINIONDEVICESETTINGS_GAIN']._serialized_end=2383
  _globals['_MINIONDEVICESETTINGS_DECIMATION']._serialized_start=2385
  _globals['_MINIONDEVICESETTINGS_DECIMATION']._serialized_end=2456
  _globals['_MINIONDEVICESETTINGS_LOWPASSFILTER']._serialized_start=2458
  _globals['_MINIONDEVICESETTINGS_LOWPASSFILTER']._serialized_end=2579
  _globals['_MINIONDEVICESETTINGS_NONOVERLAPCLOCK']._serialized_start=2581
  _globals['_MINIONDEVICESETTINGS_NONOVERLAPCLOCK']._serialized_end=2652
  _globals['_MINIONDEVICESETTINGS_INTEGRATIONCAPACITOR']._serialized_start=2654
  _globals['_MINIONDEVICESETTINGS_INTEGRATIONCAPACITOR']._serialized_end=2767
  _globals['_MINIONDEVICESETTINGS_FANSPEED']._serialized_start=2769
  _globals['_MINIONDEVICESETTINGS_FANSPEED']._serialized_end=2871
  _globals['_MINIONDEVICESETTINGS_CHANNELCONFIG']._serialized_start=2874
  _globals['_MINIONDEVICESETTINGS_CHANNELCONFIG']._serialized_end=3319
  _globals['_CHANGESETTINGSREQUEST']._serialized_start=3322
  _globals['_CHANGESETTINGSREQUEST']._serialized_end=3513
  _globals['_CHANGESETTINGSRESPONSE']._serialized_start=3515
  _globals['_CHANGESETTINGSRESPONSE']._serialized_end=3539
  _globals['_GETSETTINGSREQUEST']._serialized_start=3541
  _globals['_GETSETTINGSREQUEST']._serialized_end=3561
  _globals['_GETSETTINGSRESPONSE']._serialized_start=3563
  _globals['_GETSETTINGSRESPONSE']._serialized_end=3657
  _globals['_GETFANSPEEDREQUEST']._serialized_start=3659
  _globals['_GETFANSPEEDREQUEST']._serialized_end=3679
  _globals['_GETFANSPEEDRESPONSE']._serialized_start=3681
  _globals['_GETFANSPEEDRESPONSE']._serialized_end=3715
  _globals['_MINIONDEVICESERVICE']._serialized_start=3718
  _globals['_MINIONDEVICESERVICE']._serialized_end=4097
...
Attributes:
    ...
    bias_voltage_lookup_table:
        ...
        ``enable_bias_voltage_lookup``.  Up to 128 values can be
        provided. The values have the same constraints as
        ``bias_voltage``.
    samples_per_lut:
        The number of samples each lookup table entry is valid for.
        If this value is valid then precise waveform will be enabled
        for the values in the bias lookup table (must contain at least
        2 entries). Set to zero if you want to disable this feature
        later - if left blank this property will remain unchanged.
