...
class DataService(object):
    def __init__(self, channel: grpc.Channel) -> None:
        ...
        self._pb = data_pb2
        self._full_name = "minknow_api.data.DataService"

    
    def get_channel_states(self, _message: typing.Optional[typing.Union[GetChannelStatesRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[GetChannelStatesResponse]:
    ...
    def get_data_types(self, _message: typing.Optional[typing.Union[GetDataTypesRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def get_signal_bytes(self, _message: typing.Optional[typing.Union[GetSignalBytesRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[GetSignalBytesResponse]:
    ...
    def get_signal_min_max(self, _message: typing.Optional[typing.Union[GetSignalMinMaxRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[GetSignalMinMaxResponse]:
    ...
    def reset_channel_states(self, _message: typing.Optional[typing.Union[ResetChannelStatesRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def lock_channel_states(self, _message: typing.Optional[typing.Union[LockChannelStatesRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def unlock_channel_states(self, _message: typing.Optional[typing.Union[UnlockChannelStatesRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def get_live_reads(self, iterator: typing.Iterator[GetLiveReadsRequest]) -> typing.Iterator[GetLiveReadsResponse]:
    ...
    def record_adaptive_sampling_information(self, _message: typing.Optional[typing.Union[RecordAdaptiveSamplingInformationRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        """Record information about adaptive-sampling for telemetry. This is optional
        and will not change how adaptive sampling works.This RPC is idempotent. It may change the state of the system, but if the requested
    ...
    def get_read_statistics(self, _message: typing.Optional[typing.Union[GetReadStatisticsRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def get_experiment_yield_info(self, _message: typing.Optional[typing.Union[GetExperimentYieldInfoRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
