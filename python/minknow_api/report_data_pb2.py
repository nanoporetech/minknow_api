...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_BASECALLERINFORMATION_DORADOMODELNAME'].fields_by_name['analyte_type']._loaded_options = None
  _globals['_BASECALLERINFORMATION_DORADOMODELNAME'].fields_by_name['analyte_type']._serialized_options = b'\240\265\030\000'
  _globals['_BASECALLERINFORMATION_DORADOMODELNAME'].fields_by_name['pore_type']._loaded_options = None
  _globals['_BASECALLERINFORMATION_DORADOMODELNAME'].fields_by_name['pore_type']._serialized_options = b'\240\265\030\000'
  _globals['_BASECALLERINFORMATION_DORADOMODELNAME'].fields_by_name['chemistry_type']._loaded_options = None
  _globals['_BASECALLERINFORMATION_DORADOMODELNAME'].fields_by_name['chemistry_type']._serialized_options = b'\240\265\030\000'
  _globals['_BASECALLERINFORMATION_DORADOMODELNAME'].fields_by_name['translocation_speed']._loaded_options = None
  _globals['_BASECALLERINFORMATION_DORADOMODELNAME'].fields_by_name['translocation_speed']._serialized_options = b'\240\265\030\000'
  _globals['_BASECALLERINFORMATION_DORADOMODELNAME'].fields_by_name['model_type']._loaded_options = None
  _globals['_BASECALLERINFORMATION_DORADOMODELNAME'].fields_by_name['model_type']._serialized_options = b'\240\265\030\000'
  _globals['_BASECALLERINFORMATION_DORADOMODELNAME'].fields_by_name['model_version']._loaded_options = None
  _globals['_BASECALLERINFORMATION_DORADOMODELNAME'].fields_by_name['model_version']._serialized_options = b'\240\265\030\000'
  _globals['_BASECALLERINFORMATION'].fields_by_name['modifications']._loaded_options = None
  _globals['_BASECALLERINFORMATION'].fields_by_name['modifications']._serialized_options = b'\240\265\030\000'
  _globals['_HOST'].fields_by_name['serial']._loaded_options = None
  _globals['_HOST'].fields_by_name['serial']._serialized_options = b'\240\265\030\000'
  _globals['_HOST'].fields_by_name['product_name']._loaded_options = None
  _globals['_HOST'].fields_by_name['product_name']._serialized_options = b'\240\265\030\000'
  _globals['_ACQUISITIONOUTPUTTYPES']._serialized_start=3296
  _globals['_ACQUISITIONOUTPUTTYPES']._serialized_end=3451
  _globals['_ACQUISITIONOUTPUT']._serialized_start=393
  _globals['_ACQUISITIONOUTPUT']._serialized_end=546
  _globals['_READLENGTHHISTOGRAM']._serialized_start=549
  _globals['_READLENGTHHISTOGRAM']._serialized_end=854
  _globals['_BASECALLBOXPLOT']._serialized_start=857
  _globals['_BASECALLBOXPLOT']._serialized_end=1001
  _globals['_BASECALLERINFORMATION']._serialized_start=1004
  _globals['_BASECALLERINFORMATION']._serialized_end=1364
  _globals['_BASECALLERINFORMATION_DORADOMODELNAME']._serialized_start=1174
  _globals['_BASECALLERINFORMATION_DORADOMODELNAME']._serialized_end=1364
  _globals['_ACQUISTIONREPORTDATA']._serialized_start=1367
  _globals['_ACQUISTIONREPORTDATA']._serialized_end=2465
  _globals['_HOST']._serialized_start=2467
  _globals['_HOST']._serialized_end=2523
  _globals['_REPORTDATA']._serialized_start=2526
  _globals['_REPORTDATA']._serialized_end=2842
  _globals['_SEQUENCERINFO']._serialized_start=2845
  _globals['_SEQUENCERINFO']._serialized_end=3121
  _globals['_SEQUENCERINFO_POSITION']._serialized_start=3024
