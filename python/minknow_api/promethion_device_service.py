...
class PromethionDeviceService(object):
    ...
    def __init__(self, channel: grpc.Channel) -> None:
        ...
        self._full_name = "minknow_api.promethion_device.PromethionDeviceService"
    ...
    def change_pixel_block_settings(self, _message: typing.Optional[typing.Union[ChangePixelBlockSettingsRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        """Change the settings which apply specific pixel blocks.This RPC is idempotent. It may change the state of the system, but if the requested
        change has already happened, it will not fail because of this, make any additional
        changes or return a different value.
    ...
    def get_pixel_block_settings(self, _message: typing.Optional[typing.Union[GetPixelBlockSettingsRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def change_pixel_settings(self, _message: typing.Optional[typing.Union[ChangePixelSettingsRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        """Change the settings which apply to the referenced pixels.This RPC is idempotent. It may change the state of the system, but if the requested
        change has already happened, it will not fail because of this, make any additional
        changes or return a different value.
    ...
    def get_pixel_settings(self, _message: typing.Optional[typing.Union[GetPixelSettingsRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
