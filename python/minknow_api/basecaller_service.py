...
class Basecaller(object):
    ...
    def __init__(self, channel: grpc.Channel) -> None:
        ...
        self._full_name = "minknow_api.basecaller.Basecaller"

    
    def list_configs_by_kit(self, _message: typing.Optional[typing.Union[ListConfigsByKitRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def start_basecalling(self, _message: typing.Optional[typing.Union[StartBasecallingRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        ...
        Args:
            ...
            recursive (bool, optional): Recursively find input files to basecall in the `input_reads_directories`.

                If False, only the input files directly in one of the `input_reads_directories` will be
    ...
    def start_barcoding(self, _message: typing.Optional[typing.Union[StartBarcodingRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def start_post_processing_protocol(self, _message: typing.Optional[typing.Union[StartPostProcessingProtocolRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def start_alignment(self, _message: typing.Optional[typing.Union[StartAlignmentRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        ...
        Args:
            ...
            recursive (bool, optional): Recursively find input files to align in the `input_reads_directories`.
    ...
    def cancel(self, _message: typing.Optional[typing.Union[CancelRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        """Stop a basecalling that was started by start_basecalling_reads().

        Since 3.5This RPC is idempotent. It may change the state of the system, but if the requested
    ...
    def get_info(self, _message: typing.Optional[typing.Union[GetInfoRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[GetInfoResponse]:
    ...
    def clear_info(self, _message: typing.Optional[typing.Union[ClearInfoRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        ...
        Since 5.9This RPC is idempotent. It may change the state of the system, but if the requested
        change has already happened, it will not fail because of this, make any additional
        changes or return a different value.
    ...
    def watch(self, _message: typing.Optional[typing.Union[WatchRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> typing.Iterator[WatchResponse]:
    ...
    def make_alignment_index(self, _message: typing.Optional[typing.Union[MakeAlignmentIndexRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def list_post_processing_protocols(self, _message: typing.Optional[typing.Union[ListPostProcessingProtocolsRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
        ...
        Since 4.4This RPC is idempotent. It may change the state of the system, but if the requested
        change has already happened, it will not fail because of this, make any additional
        changes or return a different value.
    ...
    def list_settings_for_post_processing_protocol(self, _message: typing.Optional[typing.Union[ListSettingsForPostProcessingProtocolRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def update_post_processing_protocol_progress(self, _message: typing.Optional[typing.Union[UpdateProgressRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
    ...
    def send_ping(self, _message: typing.Optional[typing.Union[SendPingRequest, MessageWrapper]] = None, _timeout: typing.Optional[float] = None, **kwargs: typing.Any) -> MessageWrapper:
