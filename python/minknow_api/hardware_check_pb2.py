...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_HARDWARECHECKSERVICE'].methods_by_name['start_hardware_check']._loaded_options = None
  _globals['_HARDWARECHECKSERVICE'].methods_by_name['start_hardware_check']._serialized_options = b'\220\002\002'
  _globals['_HARDWARECHECKSERVICE'].methods_by_name['stop_hardware_check']._loaded_options = None
  _globals['_HARDWARECHECKSERVICE'].methods_by_name['stop_hardware_check']._serialized_options = b'\220\002\002'
  _globals['_HARDWARECHECKSERVICE'].methods_by_name['update_hardware_check_results']._loaded_options = None
  _globals['_HARDWARECHECKSERVICE'].methods_by_name['update_hardware_check_results']._serialized_options = b'\220\002\002'
  _globals['_HARDWARECHECKSERVICE'].methods_by_name['stream_hardware_check_results']._loaded_options = None
  _globals['_HARDWARECHECKSERVICE'].methods_by_name['stream_hardware_check_results']._serialized_options = b'\220\002\001'
  _globals['_HARDWARECHECKSERVICE'].methods_by_name['generate_hardware_check_report']._loaded_options = None
